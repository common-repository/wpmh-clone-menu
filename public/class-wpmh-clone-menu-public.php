 ...
 * @subpackage Wpmh_Clone_Menu/public
 */
...
class Wpmh_Clone_Menu_Public {
	...
	public function wpmh_clone_menu_enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wpmh-clone-menu-public.css', array(), $this->version, 'all' );
	...
	public function wpmh_clone_menu_enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wpmh-clone-menu-public.js', array( 'jquery' ), $this->version, false );
